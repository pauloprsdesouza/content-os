...
| AI worker | `CONTENT_OS_AI_STUB`, `CONTENT_OS_RABBITMQ_URL`, `CONTENT_OS_API_BASE_URL`, `CONTENT_OS_WORKER_API_KEY`, `CONTENT_OS_LITELLM_API_BASE`, `CONTENT_OS_LITELLM_API_KEY`, `CONTENT_OS_LITELLM_MODEL_ALIAS` |
| OpenAlex | `OPENALEX__BASEURL`, `OPENALEX__MAILTO`, `OPENALEX__APIKEY`, `OPENALEX__TIMEOUTSECONDS`, `OPENALEX__MAXWORKS` |
...
- Host: `192.168.10.13` (Postgres `:5432`, RabbitMQ `:5672`, LiteLLM `:4000`)
- Database: `contentos`
